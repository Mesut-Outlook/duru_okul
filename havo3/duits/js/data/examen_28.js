/* Proeftoets ex-h3-duits-28 — Proeftoets 28 — Brandbestrijding, THW & Naamvalstoepassingen
   Neue Kontakte 3 HAVO Hoofdstuk 6 */
DURU.registerExamen({
  "id": "ex-h3-duits-28",
  "hoofdstuk": 6,
  ...
  "vragen": [
    {
      ...
      "opties": [
        "De brandweer bluste de brand in enkele minuten.",
        "De brandweer kwam na enkele minuten aan.",
        "De brand breidde zich in enkele minuten uit.",
        "Het vuur laaide na enkele minuten weer op."
      ],
      "antwoord": 0,
    ...
    },
    {
      ...
      "opties": [
        "Een brandweeracademie voor studenten.",
        "Een museum over historische brandspuiten.",
        "Een vrijwillig brandweerkorps bestaande uit getrainde dorpsbewoners/burgers.",
    ...
    },
    {
      ...
      "opties": [
        "Blauw met witte belettering",
        "Rood met gele strepen",
        "Groen met zilver",
        "Geel met rood"
      ],
      "antwoord": 0,
