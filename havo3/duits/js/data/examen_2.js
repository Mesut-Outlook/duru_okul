/* Proeftoets ex-h3-duits-2 — Proeftoets 2 — Seizoenen, Maanden & Weersvoorspelling
  ...
  "vragen": [
    {
      ...
      "opties": [
        "In de middag komt er onweer opzetten.",
        "In de ochtend schijnt de zon volop.",
        "Het gaat vanavond hard sneeuwen.",
        "De wind gaat vanmiddag liggen."
      ],
      "antwoord": 0,
    ...
    },
    {
      ...
      "opties": [
        "Het is vijf graden boven nul.",
        "Het is vijf graden onder nul.",
        "Het regent al vijf uur.",
        "Het sneeuwt vijf centimeter."
      ],
      "antwoord": 1,
