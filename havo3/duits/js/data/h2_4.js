...
DURU.register({
  ...
  "vragen": [
    ...
    {
      "type": "waaronwaar",
      "vraag": "Het Duitse woord 'die Erkältung' betekent een gebroken been.",
      "antwoord": false,
      "uitleg": "Onwaar! 'Die Erkältung' is een verkoudheid (Wortschatz H2)."
    },
    {
      "type": "waaronwaar",
    ...
    {
      "type": "invoer",
      "vraag": "Wat is het Duitse woord voor 'de griep' (met lidwoord)?",
      "antwoord": "die Grippe|Grippe",
      "uitleg": "Griep is 'die Grippe' (Wortschatz H2)."
    },
    {
      "type": "invoer",
      "vraag": "Vertaal het woord tussen haakjes: 'Nach dem Fußballtraining habe ich (spierpijn).' Vul het Duitse zelfstandig naamwoord in.",
      "antwoord": "Muskelkater|einen Muskelkater|der Muskelkater",
      "uitleg": "Spierpijn is 'der Muskelkater': 'Ich habe Muskelkater' (Wortschatz H2)."
    }
  ]
});
