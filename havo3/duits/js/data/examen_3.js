/* Proeftoets ex-h3-duits-3 — Proeftoets 3 — Duitse Landschappen, Rivieren & Grammatica
...
DURU.registerExamen({
  ...
  "vragen": [
    ...
    },
    {
      ...
      "opties": [
        "De emmers zijn vol met water.",
        "Het sneeuwt heel zachtjes.",
        "Het regent pijpenstelen (giet van de regen).",
    ...
    },
    {
      ...
      "opties": [
        "In het noorden schijnt de zon.",
        "De noordenwind gaat liggen.",
        "Het sneeuwt hevig in het noorden.",
        "Er waait een sterke wind uit het noorden."
      ],
      "antwoord": 3,
