/* Proeftoets ex-h3-duits-15 — Proeftoets 15 — Eindtoets Hoofdstuk 3 (Alles gemixt)
   Neue Kontakte 3 HAVO Hoofdstuk 3 */
DURU.registerExamen({
  "id": "ex-h3-duits-15",
  "hoofdstuk": 3,
  ...
  "vragen": [
    {
      ...
      "opties": [
        "Wir mussten gestern umsteigen, weil der Zug Verspätung hatte.",
        "Wir müssten gestern umsteigen, weil der Zug Verspätung hatte.",
        "Wir mussten gestern umgestiegen, weil der Zug Verspätung war.",
        "Wir gemusst gestern umsteigen."
      ],
      "antwoord": 0,
    ...
    },
    {
      ...
      "opties": [
        "Ga bij het stoplicht rechtdoor.",
        "Rijd over de brug naar links.",
        "Sla bij het kruispunt rechtsaf.",
        "Stop voor de rotonde."
      ],
      "antwoord": 2,
    ...
    },
    {
      ...
      "opties": [
        "het treinkaartje",
        "de bagageruimte",
        "de stoelreservering / zitplaatsreservering",
        "de restauratiewagen"
      ],
      "antwoord": 2,
    ...
    },
    {
      ...
      "opties": [
        "4 (Duits, Frans, Italiaans, Retoromaans)",
        "1 (alleen Duits)",
        "2 (Duits en Frans)",
        "3 (Duits, Engels, Frans)"
      ],
      "antwoord": 0,
