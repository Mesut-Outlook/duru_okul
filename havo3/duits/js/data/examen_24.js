/* Proeftoets ex-h3-duits-24 — Proeftoets 24 — Carrièrekeuzes, Talen & Werkwoordvervoeging
   Neue Kontakte 3 HAVO Hoofdstuk 5 */
DURU.registerExamen({
  "id": "ex-h3-duits-24",
  "hoofdstuk": 5,
  ...
  "vragen": [
    {
      ...
      "opties": [
        "Welke schoolvakken vind je het leukst?",
        "Hoe laat zijn je lessen afgelopen?",
    ...
    },
    {
      ...
      "opties": [
        ...
        "Het diploma van de basisschool",
        "Het diploma van de Realschule (ongeveer MAVO/HAVO-onderbouw niveau)",
        "Een universitair masterdiploma"
      ],
      "antwoord": 2,
    ...
    },
    {
      ...
      "opties": [
        "Hij werkt als IT-specialist bij Siemens.",
        "Hij studeert informatica aan de universiteit.",
        "Hij zoekt een stageplek bij Siemens.",
        "Zijn vader is directeur bij Siemens."
      ],
      "antwoord": 0,
