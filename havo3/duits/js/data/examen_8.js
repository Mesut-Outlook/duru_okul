/* Proeftoets ex-h3-duits-8 — Proeftoets 8 — Gezonde Leefstijl, Sport & Voornaamwoorden
  ...
  "vragen": [
    {
      ...
      "opties": [
        "Je zou meer moeten bewegen / sporten.",
        "Je moet minder slapen.",
        "Je mag niet meer wandelen.",
        "Je moet op dieet gaan."
      ],
      "antwoord": 0,
    ...
    },
    {
      ...
      "opties": [
        "Hij heeft zijn linkerknie geblesseerd/bezeerd.",
        "Hij heeft hoofdpijn aan de linkerkant.",
        "Zijn rechterbeen is gebroken.",
        "Hij heeft pijn aan zijn schouder."
      ],
      "antwoord": 0,
    ...
    },
    {
      ...
      "opties": [
        "Een ziekenhuis voor spoedeisende hulp.",
        "Een officieel erkend herstel- en kuuroord met thermale baden.",
        "Een sportacademie voor topsporters.",
        "Een apotheek in het centrum."
      ],
      "antwoord": 1,
