/* Proeftoets ex-h3-duits-21 — Proeftoets 21 — Beroepen, Opleidingen & Sterke Werkwoorden (a→ä)
...
DURU.registerExamen({
  ...
  "vragen": [
    ...
    },
    {
      ...
      "opties": [
        "Ich möchte als Journalist arbeiten.",
        "Ich will wie ein Journalist arbeiten.",
        "Ich möchte als der Journalist arbeiten.",
        "Ich will arbeiten als einen Journalist."
      ],
      "antwoord": 0,
    ...
    },
    {
      ...
      "opties": [
        "het eindexamen",
        "het basisonderwijs",
        "de beroepsopleiding / het leertraject",
        "de universiteit"
      ],
      "antwoord": 2,
    ...
    },
    {
      ...
      "opties": [
        "Als een zachte Nederlandse keelklank",
        "Als een harde 'g' (zoals in good of goal)",
        "Als een 'k'",
        "Als een 'j'"
      ],
      "antwoord": 1,
