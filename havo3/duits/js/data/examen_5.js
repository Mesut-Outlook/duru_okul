/* Proeftoets ex-h3-duits-5 — Proeftoets 5 — Eindtoets Hoofdstuk 1 (Alles gemixt)
   Neue Kontakte 3 HAVO Hoofdstuk 1 */
DURU.registerExamen({
  "id": "ex-h3-duits-5",
  "hoofdstuk": 1,
  ...
  "vragen": [
    {
      ...
      "opties": [
        "Gestern war es sonnig und wir hatten viel Spaß.",
        "Gestern waren es sonnig und wir habten viel Spaß.",
        "Gestern war es sonnig und wir waren viel Spaß.",
        "Gestern wurde es Regen und wir hattet Spaß."
      ],
      "antwoord": 0,
    ...
    },
    {
      ...
      "opties": [
        "Hoe was het weer vorig weekend?",
        "Wat is het weerbericht voor het weekend?",
        "Gaat het regenen op maandag?",
        "Hoe warm is het in het buitenland?"
      ],
      "antwoord": 1,
    ...
    },
    {
      ...
      "opties": [
        ...
        "De zon is achter de mist verdwenen.",
        "De lucht is strakblauw en onbewolkt.",
        "Er hangen donkere onweerswolken."
      ],
      "antwoord": 2,
