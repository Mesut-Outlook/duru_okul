...
(function () {
  ...
  var SLEUTEL = "duru_2627_duits_v1";
  var P = laad();
  ...
  var BADGES = [
    ...
    { id: "prof", ico: "🎓", naam: "Duits-professor", check: function () { return P.xp >= 500; } },
  ];
  ...
  function renderHome() {
    ...
    html += '<section class="hero view">' +
      ...
      '<p>Welkom in jouw eigen Duits-academie. Leer alles over <b>Duitse woorden</b>, <b>naamvallen</b> en <b>grammatica</b>, ' +
    ...
    html += '<div class="footer">Gemaakt met 🏛️ en 💜 voor Duru · Duits HAVO 3</div>';
    app.innerHTML = html;
    updateStats();
  }
