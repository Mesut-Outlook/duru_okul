/* =========================================================
   Duru's Maatschappijleer Academie — Engine
...
(function () {
  ...
  var SLEUTEL = "duru_2627_maatschappijleer_v1";
  var P = laad();
  ...
  var BADGES = [
    ...
    { id: "prof", ico: "🎓", naam: "Maatschappijleer-expert", check: function () { return P.xp >= 500; } },
  ];
  ...
  function renderHome() {
    ...
    html += '<section class="hero view">' +
      ...
      '<p>Welkom in jouw eigen maatschappijleer-academie. Leer alles over <b>samenleven, rechten en de overheid</b> en <b>maatschappijleer</b>, ' +
    ...
    html += '<div class="footer">Gemaakt met 🏛️ en 💜 voor Duru · Maatschappijleer HAVO 3</div>';
    app.innerHTML = html;
    updateStats();
  }
  ...
  function renderDashboard() {
    ...
    // Sort all registered Maatschappijleer exams by their numerical title
