/* =========================================================
   Duru's Frans Academie — Spreekvaardigheid 4 · p. 126 (blok C & G) · Phrases-clés Reizen & Vakantie
   Grandes Lignes 3 HAVO — Unité 3
   ========================================================= */
DURU.registerExamen({
  "id": "ex-h3-frans-u3-v4",
  "hoofdstuk": 3,
  "hoofdstukTitel": "Unité 3 — En route!",
  "titel": "Spreekvaardigheid 4 · p. 126 (blok C & G) · Phrases-clés Reizen & Vakantie",
  "vak": "Frans · HAVO 3 (U3)",
  "icoon": "🗣️",
  "duurMin": 20,
  "vragen": [
    ...
    {
      "type": "waaronwaar",
      "vraag": "De Franse vraag <i>'Tu pars à quelle heure?'</i> betekent: 'Waar ga je naartoe?'.",
      "antwoord": false,
      "uitleg": "Onwaar. 'Tu pars à quelle heure?' betekent 'Hoe laat vertrek je?' ('Waar ga je naartoe?' is 'Tu vas où?')."
    },
    {
      "type": "waaronwaar",
      "vraag": "De Franse zin <i>'Non, il faut changer à Lyon'</i> betekent dat je in Lyon moet overstappen.",
      "antwoord": true,
      "uitleg": "Waar. 'Changer à ...' betekent 'overstappen in ...'."
    },
    {
      "type": "mc",
    ...
    },
    {
      ...
      "antwoord": 3,
      "uitleg": "'Oui, c'est obligatoire' betekent 'Ja, dat is verplicht'."
    },
    {
      "type": "waaronwaar",
      "vraag": "De uitdrukking <i>'Pas mal, il y a une piscine'</i> betekent dat er geen zwembad aanwezig is.",
      "antwoord": false,
      "uitleg": "Onwaar. 'Pas mal, il y a une piscine' betekent 'Niet slecht, er is een zwembad'."
    },
    {
      "type": "waaronwaar",
      "vraag": "De Franse vraag <i>'Ça coûte cher?'</i> betekent 'Is het duur?'.",
      "antwoord": true,
      "uitleg": "Waar. 'Cher' betekent 'duur'."
    },
    {
      "type": "invul",
      "vraag": "Vul het ontbrekende Franse woord in voor tijd: <i>Je pars à deux ... (om twee uur, p. 126).</i>",
      "antwoord": "heures|heure",
      "uitleg": "'À deux heures' betekent om twee uur."
    },
    {
      "type": "invul",
      "vraag": "Vul het Franse werkwoord in voor overstappen (p. 126): <i>Non, il faut ... à Paris.</i>",
      "antwoord": "changer",
      "uitleg": "'Changer' is het werkwoord voor overstappen van trein of metro."
    },
    {
      "type": "mc",
    ...
    {
      "type": "open",
      "vraag": "Hoe vraag je in het Frans informeel 'Waar ga je heen?' (drie woorden, p. 126)?",
      "sleutelwoorden": [
        "tu vas ou/tu vas où"
      ],
      "minTreffers": 1,
      "modelantwoord": "De vraag is 'Tu vas où?'.",
      "uitleg": "'Tu vas où?' betekent 'Waar ga je heen?'."
    },
    {
      "type": "open",
      "vraag": "Hoe zeg je in het Frans dat reserveren verplicht is: 'Oui, c'est ...' (één woord voor 'verplicht', p. 126)?",
      "sleutelwoorden": [
        "obligatoire"
      ],
      "minTreffers": 1,
      "modelantwoord": "Het Franse woord voor verplicht is 'obligatoire'.",
      "uitleg": "'Obligatoire' betekent verplicht."
    }
  ]
});
