/* Proeftoets Woordenschat 1 · Le pont: Eten, drinken, restaurant & basiswerkwoorden (Ch 1–5)
...
DURU.registerExamen({
  ...
  "vragen": [
    ...
    {
      "type": "invul",
      "vraag": "Vul de juiste vorm van het delend lidwoord in: 'Tu veux ____ (water) minérale ?'",
      "antwoord": "de l'",
      "uitleg": "'Eau' begint met een klinker, dus 'de l''."
    },
    {
      "type": "invul",
      "vraag": "Vul de juiste présent-vorm van het werkwoord 'venir' in: 'Mes grands-parents ____ (komen) demain chez nous.'",
      "antwoord": "viennent",
