/* Proeftoets DELF A2 & Examentraining · Leesbegrip, uitdrukkingen & schrijfvaardigheid
...
DURU.registerExamen({
  ...
  "vragen": [
    ...
    },
    {
      ...
      "opties": [
        "Ik ben gewend op kinderen te passen.",
        "Ik heb zelf kinderen.",
        "Ik wil geen kinderen zien.",
        "Ik vind kinderen irritant."
      ],
      "antwoord": 0,
    ...
    {
      "type": "mc",
      "vraag": "Wat betekent <b>'s'inscrire'</b> in de annonce over de logowedstrijd (p. 296): 'Commencez par vous inscrire !'?",
      "opties": [
      ...
      "antwoord": 3,
      "uitleg": "'S'inscrire' betekent zich inschrijven/aanmelden. In de annonce: 'Vous voulez participer ? Commencez par vous inscrire !'"
    },
    {
      "type": "mc",
    ...
    {
      "type": "mc",
      "vraag": "Wat betekent <b>'accessible'</b> in de tekst over het Stade de France (p. 294): 'La visite est accessible aux personnes à mobilité réduite'?",
      "opties": [
        "gevaarlijk",
        "toegankelijk",
        "duur",
      ...
      "antwoord": 1,
      "uitleg": "'Accessible' betekent toegankelijk: ook mensen met een beperkte mobiliteit kunnen de rondleiding volgen."
    },
    {
      "type": "mc",
    ...
    {
      "type": "invul",
      "vraag": "Vul het juiste vraagwoord in voor 'Waarom': '____ (Waarom) tu veux travailler à Paris ?'",
      "antwoord": "Pourquoi|pourquoi",
      "uitleg": "'Pourquoi' betekent waarom."
    },
    {
      "type": "invul",
      "vraag": "Vul de juiste formule in voor 'Met vriendelijke groet': '____ (Met vriendelijke groet), Duru.'",
