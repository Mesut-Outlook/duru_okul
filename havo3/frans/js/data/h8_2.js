/* Onderwerp: Herhaling Ch 1–6: Karakter, Dagindeling & Vergelijkingen / Tijden
  ...
  "vragen": [
    {
      ...
      "opties": [
        "Emma est moins sportive que Pauline.",
        "Emma est meilleure sportive que Pauline.",
        "Emma est plus sportive que Pauline.",
        "Emma est aussi sportive que Pauline."
      ],
      "antwoord": 3,
    ...
    },
    {
      ...
      "opties": [
        "Met een vorm van 'aller' + het hele werkwoord (infinitief).",
        "Met de stam van het werkwoord + uitgangen.",
        "Met een vorm van 'être' + voltooid deelwoord.",
        "Met een vorm van 'avoir' + voltooid deelwoord."
      ],
      "antwoord": 0,
