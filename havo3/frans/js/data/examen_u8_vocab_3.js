/* Proeftoets Woordenschat 3 · Le pont: Geld, materialen & signaalwoorden (Ch 1–7)
...
DURU.registerExamen({
  ...
  "vragen": [
    ...
    },
    {
      ...
      "opties": [
        "een reden ('omdat')",
        "een tegenstelling ('toch / echter')",
        "een opsomming ('en')",
        "een tijdstip ('gisteren')"
      ],
      "antwoord": 1,
    ...
    {
      "type": "mc",
      "vraag": "Wat betekent <b>'en verre'</b>?",
      "opties": [
        "van hout",
        "van stof",
        "van metaal",
      ...
      "antwoord": 3,
      "uitleg": "'En verre' betekent van glas (p. 267)."
    },
    {
      "type": "mc",
    ...
    {
      "type": "mc",
      "vraag": "Wat betekent het materiaal <b>'en plastique'</b>?",
      "opties": [
        "van leer",
        "van hout",
        "van plastic",
      ...
      "antwoord": 2,
      "uitleg": "'En plastique' betekent van plastic (p. 267)."
    },
    {
      "type": "mc",
      "vraag": "Wat betekent het werkwoord <b>'payer'</b>?",
      "opties": [
        "lenen",
        "betalen",
        "verdienen",
    ...
    {
      "type": "invul",
      "vraag": "Vul in (materiaal): 'Cette table est faite ____ (van hout).'",
      "antwoord": "en bois",
      "uitleg": "Materialen geef je aan met 'en': en bois (van hout), en verre, en métal, en tissu, en plastique."
    },
    {
      "type": "invul",
    ...
    {
      "type": "open",
      "vraag": "Hoe zeg je in het Frans 'sparen' en 'uitgeven'? Noem beide.",
      "modelantwoord": "Sparen is 'faire des économies', uitgeven is 'dépenser'.",
      "sleutelwoorden": [
        "économies/economies",
        "dépenser/depenser/dépense/depense"
      ],
      "minTreffers": 2,
      "uitleg": "Sparen = faire des économies, uitgeven = dépenser (Unité 7)."
    },
    {
      "type": "open",
