/* Proeftoets Woordenschat 2 · Le pont: Identiteit, school, tijden & vergelijkingen (Ch 1–6)
  ...
  "vragen": [
    ...
    },
    {
      ...
      "opties": [
        ...
        "Elle est meilleure intelligente que son frère."
      ],
      "antwoord": 1,
    ...
    {
      "type": "invul",
      "vraag": "Vul de juiste comparatief in voor 'minder snel dan' (vrouwelijk): 'Cette voiture est ____ (minder snel dan) le train.'",
      "antwoord": "moins rapide que",
      "uitleg": "'Minder ... dan' is 'moins ... que'."
    },
    {
      "type": "invul",
      "vraag": "Vul de juiste vervoeging in van 'se réveiller' (present, je-vorm): 'Chaque matin, ____ (ik word wakker) à sept heures.'",
