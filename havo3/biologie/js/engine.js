/* =========================================================
   Duru's Biologie Academie — Engine
...
(function () {
  ...
  var SLEUTEL = "duru_2627_biologie_v1";
  var P = laad();
  ...
  function renderHome() {
    ...
    html += '<div class="footer">Gemaakt met 🧬 en 💜 voor Duru · Biologie HAVO 3</div>';
    app.innerHTML = html;
    updateStats();
  }
  ...
  function renderDashboard() {
    ...
    // Sort all registered Biologie exams by their numerical title
