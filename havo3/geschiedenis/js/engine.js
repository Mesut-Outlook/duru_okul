...
(function () {
  ...
  var SLEUTEL = "duru_2627_geschiedenis_v1";
  var P = laad();
  ...
  var BADGES = [
    ...
    { id: "prof", ico: "🎓", naam: "Geschiedenis-expert", check: function () { return P.xp >= 500; } },
  ];
  ...
  function renderHome() {
    ...
    html += '<section class="hero view">' +
      ...
      '<p>Welkom in jouw eigen geschiedenis-academie. Leer alles over <b>tijdvakken, bronnen en gebeurtenissen</b> en <b>geschiedenis</b>, ' +
    ...
    html += '<div class="footer">Gemaakt met 🕰️ en 💜 voor Duru · Geschiedenis HAVO 3</div>';
    app.innerHTML = html;
    updateStats();
  }
  ...
  function renderDashboard() {
    ...
    // Sort all registered Geschiedenis exams by their numerical title
