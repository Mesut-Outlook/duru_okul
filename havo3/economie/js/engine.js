...
(function () {
  ...
  var SLEUTEL = "duru_2627_economie_v1";
  var P = laad();
  ...
  function renderHome() {
    ...
    html += '<section class="hero view">' +
      ...
      '<div><h2>Hoi Duru! Klaar voor Economie? 🏛️</h2>' +
      '<p>Welkom bij Economie (Pincode) HAVO 3. Klik op een <b>Hoofdstuk-kaart</b> hieronder om direct de oefenquizzes per paragraaf en 20-vragige proeftoetsen te openen!</p>' +
      '<div class="hero-cta">' +
    ...
    DURU.hoofdstukken.forEach(function (h, index) {
      ...
      if (ow.length) {
        ...
        ow.forEach(function (o, i) {
          ...
          html += '<div class="topic-card ' + (h.kleur || "oranje") + '" onclick="DURU.gaNaar(\'theorie\',\'' + o.id + '\')">' +
    ...
    html += '<div class="footer" style="margin-top:40px;">Gemaakt met 🏛️ en 💜 voor Duru · Economie HAVO 3</div>';
    app.innerHTML = html;
    updateStats();
  }
