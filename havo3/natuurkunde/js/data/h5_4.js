/* =========================================================
   Duru's Natuurkunde (HAVO 3) — §5.4 Oogafwijkingen en brillen
   ========================================================= */
DURU.register({
  ...
  "vragen": [
    {
      ...
      "opties": [
        ...
        "De pupil sluit zich volledig af",
        "Het netvlies schuift 2 cm naar achteren"
      ],
      "antwoord": 1,
    ...
    },
    {
      ...
      "opties": [
        "De oogbol is te kort en het beeld valt achter het netvlies",
        "De ooglens is vertroebeld door ouderdom",
        "De oogbol is te lang (of lens te sterk), waardoor het beeld vóór het netvlies valt",
        "De oogzenuw stuurt het beeld ondersteboven door"
      ],
      "antwoord": 2,
    ...
    },
    {
      ...
      "opties": [
        ...
        "Een polariserend zonneglas",
        "Een negatieve holle lens (-)"
      ],
      "antwoord": 3,
    ...
    },
    {
      ...
      "opties": [
        "De ooglens wordt stugger en minder elastisch, waardoor accommoderen minder goed lukt",
        "De oogbol groeit plotseling 5 millimeter langer",
        "Het netvlies raakt beschadigd door uv-straling",
        "De hoornvlieskromming wordt volledig plat"
      ],
      "antwoord": 0,
