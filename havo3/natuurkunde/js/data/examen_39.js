/* =========================================================
   Duru's Natuurkunde (HAVO 3) — Toets 39 — Integrale Examentraining Paragrafen 1.1 t/m 1.3 (Mix)
   ========================================================= */
DURU.registerExamen({
  "id": "ex-h3-natuurkunde-39",
  "hoofdstuk": 1,
  "paragraaf": "mix",
  "titel": "Toets 39 — Integrale Examentraining Paragrafen 1.1 t/m 1.3 (Mix)",
  ...
  "vragen": [
    {
      ...
      "antwoord": 0,
      "uitleg": "Deel 1 (driehoek): 0,5 × 10 s × 14 m/s = 70 m. Deel 2 (rechthoek): 30 s × 14 m/s = 420 m. Totale afstand s = 70 + 420 = 490 meter."
    },
    {
      "type": "mc",
      ...
      "antwoord": 1,
      "uitleg": "De vertraging is a = Δv / t = (0 - 30) / 5,0 = -6,0 m/s². De benodigde remkracht is F<sub>res</sub> = m × a = 1500 kg × 6,0 m/s² = 9000 N."
    },
    {
      "type": "mc",
      ...
      "antwoord": 2,
      "uitleg": "Rechthoek: 5 s × 15 m/s = 75 m. Driehoek: 0,5 × (8 - 5) s × 15 m/s = 0,5 × 3 × 15 = 22,5 m. Totale afstand = 75 + 22,5 = 97,5 meter."
    },
    {
      "type": "mc",
    ...
    },
    {
      ...
      "antwoord": 0,
      "uitleg": "F<sub>res</sub> = 60.000 - 40.000 = 20.000 N omhoog. a = F<sub>res</sub> / m = 20.000 / 4000 = 5,0 m/s²."
    },
    {
      "type": "mc",
      ...
      "antwoord": 1,
      "uitleg": "Door de tegenwind wordt de luchtweerstand groter dan de trapkracht (F<sub>tegen</sub> > F<sub>spier</sub>). Daardoor ontstaat een negatieve resulterende kracht en vertraagt de fietser tot de krachten weer in evenwicht zijn."
    },
    {
      "type": "mc",
      ...
      "antwoord": 2,
      "uitleg": "Totale afstand s = 80 m, totale tijd t = 25 s. v<sub>gem</sub> = s / t = 80 / 25 = 3,2 m/s."
    },
    {
      "type": "mc",
    ...
    {
      "type": "mc",
      "vraag": "Een kist met een massa van 6,0 kg ondervindt twee horizontale krachten: F<sub>1</sub> = 35 N naar rechts en F<sub>2</sub> = 17 N naar links. Wat is de versnelling van de kist?",
      "opties": [
        "3,0 m/s² naar rechts",
        "3,0 m/s² naar links",
        "8,7 m/s² naar rechts",
      ...
      "antwoord": 0,
      "uitleg": "F<sub>res</sub> = 35 - 17 = 18 N naar rechts. a = F<sub>res</sub> / m = 18 / 6,0 = 3,0 m/s² naar rechts."
    },
    {
      "type": "mc",
      "vraag": "Een sprinter rent de 100 meter in 10,0 seconden en finisht met een topsnelheid van 12,0 m/s. Welke uitspraak over zijn gemiddelde snelheid (v<sub>gem</sub>) en topsnelheid (v<sub>max</sub>) is juist?",
      "opties": [
      ...
      "antwoord": 1,
      "uitleg": "v<sub>gem</sub> = 100 m / 10,0 s = 10,0 m/s. Zijn topsnelheid ligt hoger omdat hij vanuit stilstand moest versnellen."
    },
    {
      "type": "mc",
      ...
      "antwoord": 2,
      "uitleg": "In een (v,t)-diagram geeft de steilheid van de grafiek de versnelling aan (a = Δv / Δt). Een steilere lijn betekent een grotere versnelling."
    },
    {
      "type": "mc",
    ...
    },
    {
      ...
      "antwoord": true,
      "uitleg": "Waar. a = Δv / t = (35 - 25) / 5,0 = 10 / 5,0 = 2,0 m/s²."
    },
    {
      "type": "waaronwaar",
    ...
    },
    {
      ...
      "antwoord": false,
      "uitleg": "Niet waar. Als de auto versnelt moet F<sub>res</sub> > 0 zijn, wat betekent dat de motorkracht groter moet zijn dan de weerstandskracht (F<sub>motor</sub> > F<sub>tegen</sub>)."
    },
    {
      "type": "invul",
      ...
      "uitleg": "F<sub>res</sub> = 4400 - 2000 = 2400 N. a = F<sub>res</sub> / m = 2400 / 800 = 3,0 m/s²."
    },
    {
      "type": "invul",
      ...
      "uitleg": "v<sub>gem</sub> = s / t = 2000 m / 160 s = 12,5 m/s."
    },
    {
      "type": "open",
