/* =========================================================
   Duru's Natuurkunde (HAVO 3) — Toets 37 — Snelheid, Bewegingen & Diagrammen (Mix §1.1 t/m §1.3)
   ========================================================= */
DURU.registerExamen({
  "id": "ex-h3-natuurkunde-37",
  "hoofdstuk": 1,
  "paragraaf": "mix",
  "titel": "Toets 37 — Snelheid, Bewegingen & Diagrammen (Mix §1.1 t/m §1.3)",
  ...
  "vragen": [
    {
      ...
      "antwoord": 0,
      "uitleg": "v<sub>gem</sub> = s / t = 1500 m / 300 s = 5,0 m/s."
    },
    {
      "type": "mc",
    ...
    },
    {
      ...
      "antwoord": 2,
      "uitleg": "v<sub>gem</sub> = s / t = 4259 / 70,0 = 60,84... ≈ 60,8 m/s (dat is ongeveer 219 km/h!)."
    },
    {
      "type": "mc",
    ...
    },
    {
      ...
      "antwoord": 0,
      "uitleg": "De oppervlakte van de driehoek onder de grafiek is: oppervlakte = 0,5 × basis × hoogte = 0,5 × 4,0 s × 12 m/s = 24 m (of via v<sub>gem</sub> = 6 m/s × 4 s = 24 m)."
    },
    {
      "type": "mc",
      ...
      "antwoord": 1,
      "uitleg": "s = v × t = 5,0 m/s × 600 s = 3000 m (oftewel 3 km)."
    },
    {
      "type": "mc",
      ...
      "antwoord": 2,
      "uitleg": "v = Δs / Δt = (25 - 0) / (5,0 - 0) = 5,0 m/s."
    },
    {
      "type": "mc",
    ...
    },
    {
      ...
      "antwoord": 0,
      "uitleg": "Bij constante snelheid is de lijn horizontaal. De oppervlakte onder de lijn is een rechthoek: basis × hoogte = 6,0 s × 10 m/s = 60 meter."
    },
    {
      "type": "mc",
    ...
    },
    {
      ...
      "antwoord": 2,
      "uitleg": "Bij een eenparige vertraging is de gemiddelde snelheid precies het midden tussen begin- en eindsnelheid: v<sub>gem</sub> = (20 + 0) / 2 = 10 m/s."
    },
    {
      "type": "mc",
    ...
    },
    {
      ...
      "antwoord": true,
      "uitleg": "Waar. Vermenigvuldig je de eenheid van de verticale as (m/s) met die van de horizontale as (s), dan krijg je m/s × s = m (meter)."
    },
    {
      "type": "waaronwaar",
    ...
    },
    {
      ...
      "uitleg": "Van m/s naar km/h vermenigvuldig je met 3,6: 2,5 × 3,6 = 9,0 km/h."
    },
    {
      "type": "invul",
    ...
    },
    {
      ...
      "minTreffers": 2,
      "modelantwoord": "Je berekent de oppervlakte onder de grafiek in twee delen: Deel 1 is een driehoek (0,5 × 4 s × 8 m/s = 16 m). Deel 2 is een rechthoek (6 s × 8 m/s = 48 m). De totale afstand is de optelsom: 16 + 48 = 64 meter.",
