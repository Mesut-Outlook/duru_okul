/* Proeftoets 5 — Natuurkunde HAVO 3: Hoofdstuk 1 (Kracht en beweging - Integrale Eindtoets)
   Focus: Volledig Hoofdstuk 1 (Paragraaf 1.1 t/m 1.5) — Samenvatting, gemengde opgaven & toepassingen.
...
DURU.registerExamen({
  ...
  vragen: [
    ...
    },
    {
      ...
      antwoord: true,
      uitleg: "Waar. Volgens de eerste wet van Newton betekent F_res = 0 N dat de snelheid niet verandert (constante snelheid in een rechte lijn). Het voorwerp hoeft dus niet stil te staan!"
    },
    {
      type: "invul",
    ...
    },
    {
      ...
      antwoord: true,
      uitleg: "Waar. F_bots = m × (Δv / Δt). Door Δt groter te maken, wordt de kracht F kleiner."
    },
    {
      type: "invul",
    ...
    },
    {
      ...
      sleutelwoorden: ["reactiefase/reactietijd/constante snelheid", "remfase/vertragende beweging/remkracht", "stopafstand is som van beide"],
      minTreffers: 2,
    ...
    },
    {
      ...
      sleutelwoorden: ["luchtweerstand kwadratisch/veel groter", "W = F * s / grotere kracht vereist meer arbeid", "afstand per seconde groter"],
      minTreffers: 2,
