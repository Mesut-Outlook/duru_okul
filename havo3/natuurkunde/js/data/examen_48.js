/* =========================================================
   Duru's Natuurkunde (HAVO 3) — Toets 48 — Kernbegrippen & Formules Hoofdstuk 5 (Licht)
   Gebaseerd op Overal Natuurkunde 3 HAVO Hoofdstuk 5 (p. 171 Overzicht)
   ========================================================= */
DURU.registerExamen({
  "id": "ex-h3-natuurkunde-48",
  "hoofdstuk": 5,
  "paragraaf": "5.0",
  "titel": "Toets 48 — Kernbegrippen & Formules Hoofdstuk 5 (Licht)",
  ...
  "vragen": [
    ...
    },
    {
      ...
      "antwoord": 3,
      "uitleg": "De lenzenformule luidt: 1/v + 1/b = 1/f."
    },
    {
      "type": "waaronwaar",
      "vraag": "Iemand die <b>oudziend</b> is heeft van nature te sterke ooglenzen waardoor het vertepunt dichtbij ligt.",
      "antwoord": false,
      "uitleg": "Onwaar. Oudziendheid ontstaat doordat de ooglens stugger wordt en minder goed kan accommoderen; hierdoor schuift het nabijheidspunt naar achteren (voorbij 25 cm)."
    },
    {
      "type": "waaronwaar",
      "vraag": "Bij <b>spiegelende weerkaatsing</b> geldt dat de hoek van inval exact gelijk is aan de hoek van terugkaatsing (∠i = ∠t).",
      "antwoord": true,
      "uitleg": "Waar. Dit is de spiegelwet, waarbij beide hoeken worden gemeten ten opzichte van de normaal."
    },
    {
      "type": "mc",
    ...
    {
      "type": "mc",
      "vraag": "Een oogarts meet bij een patiënt een oogafwijking waarbij de ooglenzen te plat zijn (te zwak breken) en het beeld van dichtbij achter het netvlies valt. Welke afwijking is dit?",
      "opties": [
        "Bijziendheid",
        "Verziendheid",
        "Nachtblindheid",
      ...
      "antwoord": 1,
      "uitleg": "Bij verziendheid is de ooglens te zwak of de oogbol te kort, waardoor invallende stralen pas achter het netvlies zouden samenkomen."
    },
    {
      "type": "mc",
    ...
    {
      "type": "waaronwaar",
      "vraag": "Bij het berekenen van de lenssterkte S met de formule S = 1/f mag de brandpuntsafstand f rechtstreeks in centimeters (cm) worden ingevuld.",
      "antwoord": false,
      "uitleg": "Onwaar. Om de lenssterkte in dioptrie (dpt) te krijgen MOET de brandpuntsafstand f eerst worden omgerekend naar meters (m)."
    },
    {
      "type": "waaronwaar",
      "vraag": "Een positieve lens is in het midden dikker dan aan de randen en heeft een convergerende werking.",
      "antwoord": true,
      "uitleg": "Waar. Een bolle (positieve) lens bundelt (convergeert) evenwijdige lichtstralen naar het brandpunt."
    },
    {
      "type": "invul",
      "vraag": "Vul de ontbrekende grootheid in: De formule voor de vergrotingsfactor is N = b / ..., waarin b de beeldafstand is en de noemer staat voor de ...",
      "antwoord": "v|voorwerpsafstand",
      "uitleg": "N = b / v, waarin v staat voor de voorwerpsafstand."
    },
    {
      "type": "invul",
      "vraag": "Vul de naam van de hulplijn in: De loodrechte lijn op een spiegeloppervlak waardoor de hoek van inval wordt gemeten, heet de ...",
      "antwoord": "normaal",
      "uitleg": "De normaal is de denkbeeldige stippellijn die loodrecht (90°) op het spiegeloppervlak staat in het invalspunt."
    },
    {
      "type": "mc",
    ...
    {
      "type": "mc",
      "vraag": "Waarom weerkaatst een vel wit tekenpapier het licht <b>diffuus</b> in plaats van spiegelend?",
      "opties": [
    ...
    },
    {
      ...
      "antwoord": 3,
      "uitleg": "Het netvlies (retina) bevat de lichtgevoelige zintuigcellen die lichtsignalen omzetten in impulsen voor de oogzenuw."
    },
    {
      "type": "open",
      "vraag": "Een projector heeft een lens met brandpuntsafstand f = 10 cm. Het beeldje staat op voorwerpsafstand v = 12 cm. Bereken met de lenzenformule de beeldafstand b in centimeters (cm). Geef het getal.",
      "sleutelwoorden": [
        "60"
      ],
      "minTreffers": 1,
      "modelantwoord": "1/b = 1/f - 1/v = 1/10 - 1/12 = 6/60 - 5/60 = 1/60, dus b = 60 cm.",
      "uitleg": "1/b = 1/10 - 1/12 = 1/60, dus de beeldafstand b is 60 cm."
    },
    {
      "type": "open",
      "vraag": "Hoe noemt men de oogafwijking waarbij iemand dichtbij wel scherp ziet, maar in de verte onscherp omdat de ooglens te sterk breekt?",
      "sleutelwoorden": [
        "bijziend/bijziendheid"
      ],
      "minTreffers": 1,
      "modelantwoord": "Deze oogafwijking heet bijziendheid (of myopie).",
      "uitleg": "Bijziendheid betekent dat men dichtbij goed ziet, maar veraf onscherp; dit wordt gecorrigeerd met een negatieve lens."
    }
  ]
});
