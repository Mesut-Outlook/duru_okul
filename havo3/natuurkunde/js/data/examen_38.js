/* =========================================================
   Duru's Natuurkunde (HAVO 3) — Toets 38 — Versnelling, Massa & Wet van Newton (Mix §1.1 t/m §1.3)
   ========================================================= */
DURU.registerExamen({
  "id": "ex-h3-natuurkunde-38",
  "hoofdstuk": 1,
  "paragraaf": "mix",
  "titel": "Toets 38 — Versnelling, Massa & Wet van Newton (Mix §1.1 t/m §1.3)",
  ...
  "vragen": [
    {
      ...
      "antwoord": 0,
      "uitleg": "a = Δv / Δt = (27 - 0) / 3,0 = 9,0 m/s²."
    },
    {
      "type": "mc",
      ...
      "antwoord": 1,
      "uitleg": "F<sub>res</sub> = 40.000 - 5000 = 35.000 N. a = F<sub>res</sub> / m = 35.000 / 50.000 = 0,70 m/s²."
    },
    {
      "type": "mc",
      ...
      "antwoord": 2,
      "uitleg": "a = (v<sub>eind</sub> - v<sub>begin</sub>) / t = (0 - 16) / 4,0 = -4,0 m/s². Het minteken geeft aan dat het een vertraging is."
    },
    {
      "type": "mc",
    ...
    },
    {
      ...
      "antwoord": 0,
      "uitleg": "F<sub>res</sub> = 9600 - 8000 = 1600 N omhoog. a = F<sub>res</sub> / m = 1600 / 800 = 2,0 m/s²."
    },
    {
      "type": "mc",
    ...
    },
    {
      ...
      "antwoord": 2,
      "uitleg": "a = F<sub>res</sub> / m = 45 / 30 = 1,5 m/s²."
    },
    {
      "type": "mc",
      "vraag": "Hoe kun je de formule F<sub>res</sub> = m · a omschrijven als je de massa (m) wilt berekenen?",
      "opties": [
        "m = Fres × a",
        "m = a / Fres",
        "m = Fres + a",
      ...
      "antwoord": 3,
      "uitleg": "Deel beide kanten van de formule door a: m = F<sub>res</sub> / a."
    },
    {
      "type": "mc",
      ...
      "antwoord": 0,
      "uitleg": "a = F<sub>res</sub> / m = -14 / 70 = -0,20 m/s² (een vertraging van 0,20 m/s²)."
    },
    {
      "type": "mc",
      ...
      "antwoord": 1,
      "uitleg": "F = m × a = 0,050 kg × 8000 m/s² = 400 N."
    },
    {
      "type": "mc",
      ...
      "antwoord": 2,
      "uitleg": "De vereiste vertraging a is hetzelfde. Omdat de massa van de vrachtwagen 20 keer zo groot is, is volgens F = m · a ook een 20 keer zo grote remkracht nodig."
    },
    {
      "type": "mc",
    ...
    {
      "type": "waaronwaar",
      "vraag": "Volgens F<sub>res</sub> = m · a is de kracht recht evenredig met de versnelling: dubbel zoveel kracht levert bij gelijke massa een dubbele versnelling op.",
      "antwoord": true,
    ...
    },
    {
      ...
      "antwoord": "8,4|8,4 N",
      "uitleg": "F<sub>res</sub> = m × a = 2,4 kg × 3,5 m/s² = 8,4 N."
    },
    {
      "type": "invul",
      ...
      "uitleg": "a = Δv / t = (8,0 - 2,0) / 4,0 = 6,0 / 4,0 = 1,5 m/s²."
    },
    {
      "type": "open",
    ...
    },
    {
      ...
      "uitleg": "Eerst de tegenwerkende krachten aftrekken om F<sub>res</sub> te vinden, en dan delen door de massa m."
    }
  ]
});
