/* =========================================================
   Duru's Natuurkunde (HAVO 3) — Toets 26 — Toets 26 — §1.1 Kracht bij beweging — Toets A
   Gebaseerd op Overal Natuurkunde 3 HAVO (Hoofdstuk 1 Kracht en beweging)
   ========================================================= */
DURU.registerExamen({
  "id": "ex-h3-natuurkunde-26",
  "hoofdstuk": 1,
  "paragraaf": "1.1",
  "titel": "Toets 26 — §1.1 Kracht bij beweging — Toets A",
  ...
  "vragen": [
    ...
    },
    {
        ...
        "antwoord": "(v,t)|v,t|vt|v-t|snelheid-tijd|snelheid tijd",
