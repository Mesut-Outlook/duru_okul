/* =========================================================
   Duru's Natuurkunde (HAVO 3) — Toets 34 — Toets 34 — §1.3 Kracht en versnelling — Toets C
   Gebaseerd op Overal Natuurkunde 3 HAVO (Hoofdstuk 1 Kracht en beweging)
   ========================================================= */
DURU.registerExamen({
  "id": "ex-h3-natuurkunde-34",
  "hoofdstuk": 1,
  "paragraaf": "1.3",
  "titel": "Toets 34 — §1.3 Kracht en versnelling — Toets C",
  ...
  "vragen": [
    ...
    },
    {
        ...
        "sleutelwoorden": [
            "versnelling/snelheid toename",
            "vertraging/afremmen",
            "richtingsverandering/bocht"
        ],
        "minTreffers": 2,
