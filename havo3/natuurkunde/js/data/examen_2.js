/* =========================================================
   Duru's Natuurkunde (HAVO 3) — Toets 2 — Versnelling, Massa & Wet van Newton
   ========================================================= */
DURU.registerExamen({
  ...
  "vragen": [
    ...
    },
    {
      ...
      "antwoord": "F=m*a|F=m.a|F=mxa|Fres=m*a|Fres=m.a|Fres=mxa|F=m a|F = m × a|F = m · a|F = m * a|F = m x a|Fres = m × a|Fres = m · a|Fres = m x a|F = m.a",
    ...
    },
    {
      ...
      "sleutelwoorden": [
        "traagheid/massa",
        "snelheid behouden/doorbewegen/vooruit blijven gaan"
      ],
      "minTreffers": 2,
