/* =========================================================
   Duru's Nederlands Academie — Engine
...
(function () {
  ...
  var SLEUTEL = "duru_2627_nederlands_v1";
  var P = laad();
  ...
  var BADGES = [
    ...
    { id: "prof", ico: "🎓", naam: "Nederlands-professor", check: function () { return P.xp >= 500; } },
  ];
  ...
  function renderHome() {
    ...
    html += '<section class="hero view">' +
      ...
      '<p>Welkom in jouw eigen Nederlands-academie. Leer alles over <b>woordsoorten</b>, <b>spelling</b> en <b>leesvaardigheid</b>, ' +
    ...
    html += '<div class="footer">Gemaakt met 🏛️ en 💜 voor Duru · Nederlands HAVO 3</div>';
    app.innerHTML = html;
    updateStats();
  }
