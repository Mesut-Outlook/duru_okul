...
(function () {
  ...
  function renderHome() {
    ...
    html += '<section class="hero view">' +
      ...
      '<p>Welkom in jouw eigen Engels-academie. Leer alles over <b>grammatica</b> en <b>vocabulaire</b>, ' +
    ...
    html += '<div class="footer">Gemaakt met 🏛️ en 💜 voor Duru · Engels HAVO 3</div>';
    app.innerHTML = html;
    updateStats();
  }
