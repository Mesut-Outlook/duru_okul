/* =========================================================
   Duru's Scheikunde Academie — Engine
...
(function () {
  ...
  var SLEUTEL = "duru_2627_scheikunde_v1";
  var P = laad();
  ...
  var BADGES = [
    ...
    { id: "prof", ico: "🎓", naam: "Scheikunde-professor", check: function () { return P.xp >= 500; } },
  ];
  ...
  function renderHome() {
    ...
    html += '<section class="hero view">' +
      ...
      '<p>Welkom in jouw eigen scheikunde-academie. Leer alles over <b>stoffen</b>, <b>atomen</b> en <b>reacties</b>, ' +
    ...
    html += '<div class="footer">Gemaakt met 🏛️ en 💜 voor Duru · Scheikunde HAVO 3</div>';
    app.innerHTML = html;
    updateStats();
  }
