# -*- coding: utf-8 -*-
"""
Full dataset for Overal Natuurkunde 3 HAVO Hoofdstuk 1 Kracht en beweging
Exams 26..34 (9 exams, 20 questions each, 180 questions)
"""
import sys
from build_natuurkunde_h1_textbook_exams import check_and_save

# -------------------------------------------------------------
# TOETS 26: §1.1 Kracht bij beweging — Toets A
# -------------------------------------------------------------
q26 = [
    { # 1 (A)
        "type": "mc",
    ...
    { # 20
        ...
        "sleutelwoorden": ["130 N/130 newton", "optellen/somkracht"],
        "minTreffers": 1,
...
# -------------------------------------------------------------
# TOETS 27: §1.1 Kracht bij beweging — Toets B
# -------------------------------------------------------------
q27 = [
    { # 1 (A)
        "type": "mc",
    ...
    { # 20
        "type": "open",
        "vraag": "Een fietser oefent 90 N trapkracht uit en heeft 40 N rolweerstand en 50 N luchtweerstand. Bepaal de resulterende netto kracht op de fietser.",
...
# -------------------------------------------------------------
# TOETS 28: §1.1 Kracht bij beweging — Toets C
# -------------------------------------------------------------
q28 = [
    { # 1 (A)
        "type": "mc",
...
print("§1.1 Toets 26, 27, 28 succesvol geverifieerd en opgeslagen.")
