/* =========================================================
   Duru's Economie Academie — Oefentoetsen (Examen-modus)
...
(function () {
  ...
  function renderResultaat(pct, goed, n, beoord, autoTijd) {
    ...
    h += '<div class="score-ring"><svg width="170" height="170">' +
      ...
      '<defs><linearGradient id="g2" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#15803d"/><stop offset="1" stop-color="#34d399"/></linearGradient></defs>' +
  ...
  DURU.renderPastAttemptReview = function (attemptId) {
    ...
    h += '<div class="score-ring"><svg width="170" height="170">' +
      ...
      '<defs><linearGradient id="g3" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#15803d"/><stop offset="1" stop-color="#34d399"/></linearGradient></defs>' +
      '</svg><div class="pct">' + c + '</div></div>';
